...
public class SmxGroup
{
	...
	final static Logger logger = LoggerFactory.getLogger(SmxGroup.class);

	private static final String HELP_MESSAGE = "SmxGroup [args]";
	...
	public static void main(String args[])
	{
		...
		Geometry[] geometries = regions.toArray(new Geometry[0]);
		GeometryCollection result = new GeometryFactory()
