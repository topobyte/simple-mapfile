 ...
 */
public class SmxConvexHull
{

	final static Logger logger = LoggerFactory.getLogger(SmxConvexHull.class);

	private static final String HELP_MESSAGE = "SmxConvexHull [args]";
